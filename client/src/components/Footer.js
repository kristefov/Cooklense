      ...
      <Container className="p-3 container-fluid d-flex flex-column align-center">
        ...
        <Row className="row  col-8 p-3 container-fluid justify-content-center align-items-center d-flex flex-row align-center">
          <Col className="col-2 text-center ">
            <a className="nav-link d-flex flex-column-reverse flex-wrap align-center justify-content-center align-items-center" href="https://github.com/dexit"><Image  width='32' className="rounded-circle" src="https://avatars.githubusercontent.com/u/6205151?s=64&v=4"></Image> dExIT</a>
          </Col>
          <Col className="col-2 text-center">
            <a className="nav-link d-flex flex-column-reverse flex-wrap align-center justify-content-center align-items-center" href="https://github.com/kristiyantefov"><Image width='32' className="rounded-circle"  src='https://avatars.githubusercontent.com/u/49992946?s=64&v=4'></Image> Kristiyantefov</a>
          </Col>
          <Col className="col-2 text-center">
        ...
        <Row className='align-center mt-5'>
          <Col>
          <p className="text-center text-tetriary w-100">Copyright © 2023 All rights reserved muchjoint.puff</p>
          </Col>
