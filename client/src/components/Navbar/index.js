      ...
      >
              ...
              <Nav className="ml-auto d-flex">
                    ...
                    <Col>
                      <Col className="dropdown text-end">
                        ...
                        <ul className="dropdown-menu text-small bg-light text-dark">
                          ...
                          <li>
                            <hr className="dropdown-divider  bg-light text-dark" />
                          </li>
                          <li>
                            <Nav.Link
                              className="dropdown-item  bg-light text-dark"
                ...
                <Col as="div" className="d-flex" style={{ zIndex: "100" }}>
                  ...
                  <Container className="secreted dropdown bottom-0 end-0 mb-0 me-0 bd-mode-toggle">
                    ...
                    >
                      <svg
                        className="bi my-1 theme-icon-active text-dark"
                        width="1em"
                        height="1em"
                      >
        ...
        >
          <Tab.Container defaultActiveKey="login">
            <Modal.Header
              className="d-flex flex-column justify-content-between  border-0 pb-0"
              closeButton
            ></Modal.Header>
